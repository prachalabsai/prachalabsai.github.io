  ...
  if (loading) {
     return (
        <div className="flex justify-center items-center h-64">
           ...
           <span className="ml-2 font-mono text-sm opacity-50">LOADING_PUBLICATIONS...</span>
        </div>
     );
  }
  ...
  return (
    <div className="space-y-12">
      <section className="text-center py-10">
        <h1 className="font-serif text-5xl font-bold italic mb-4">Articles</h1>
        <p className="font-serif text-xl opacity-70">Convergence. Polished thoughts and proofs.</p>
      </section>
