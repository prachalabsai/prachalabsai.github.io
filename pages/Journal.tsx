  ...
  if (loading) {
     return (
        <div className="flex justify-center items-center h-64">
           ...
           <span className="ml-2 font-mono text-sm text-[var(--text-muted)]">LOADING_ARCHIVES...</span>
        </div>
     );
  }
  ...
  return (
    <div className="space-y-12">
      <section className="text-center py-10 border-b border-[var(--border-main)]">
        <h1 className="font-serif text-5xl font-bold italic mb-4 text-[var(--text-main)]">Research Journal</h1>
        <p className="font-serif text-xl text-[var(--text-muted)]">Raw notes. The emergence of ideas.</p>
      </section>
